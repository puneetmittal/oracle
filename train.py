...
#
# Script adapted from: https://github.com/Azure/azureml-examples/blob/main/python-sdk/workflows/train/pytorch/cifar-distributed/src/train.py
# ==============================================================================
...
def main(args):
    ...
    if distributed:
        torch.distributed.init_process_group(backend=args.backend, timeout=datetime.timedelta(minutes=args.timeout))
    ...
    print("####################### LATE BINDING ##################################")
    print(f"++args.data_bckt: {args.data_bckt}++")
    ...
    if not distributed or rank == 0:
        ...
        model_path = os.path.join(os.environ.get("OCI__SYNC_DIR"), "cifar_net.pt")
